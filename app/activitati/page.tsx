	...
	const activities = [
		{
			...
			description:
				"Testează-ți instinctul de moment. Glisează rapid titlurile de știri și vezi dacă poți diferenția adevărul de ficțiune în mai puțin de 3 secunde.",
		},
		{
			id: "analiza",
			...
			description:
				"Dezbracă textul de secrete. Analizează articole suspecte și selectează cuvintele cheie care indică o tentativă clară de manipulare emoțională.",
		},
		{
			id: "erori",
			...
			description:
				"Identifică capcanele de argumentare. Scanează discursuri și texte publice pentru a descoperi erorile logice ascunse folosite de propagandiști.",
		},
		{
			id: "navigator-reflex",
			...
			description:
				"Antrenează-ți mușchiul detectiv. Folosește lupa de verificare pentru a inspecta autorul, data și sursele înainte ca o știre falsă să îți păcălească creierul.",
		},
	] as const;
			...
			<div className="max-w-6xl mx-auto space-y-8">
				<header className="space-y-4">
					...
					<p className="text-lg md:text-xl text-[#1a1a1a]/70 dark:text-white/70 max-w-2xl">
						Alege un modul de antrenament pentru a-ți dezvolta abilitățile de
						analiză a textului, detectare a manipulării și verificare a
						surselor.
					</p>
				</header>
							...
							>
								<CardHeader className="space-y-4">
									<div className="flex justify-between items-start">
										...
										<Badge
											variant={activity.badgeVariant as any}
											className="font-bold"
										>
											{activity.badge}
										</Badge>
								...
								<CardFooter className="pt-4 border-t border-[#1a1a1a]/5 dark:border-white/5">
									...
									>
										<Link href={activity.href}>Începe Activitatea</Link>
									</Button>
								</CardFooter>
							</Card>
						);
