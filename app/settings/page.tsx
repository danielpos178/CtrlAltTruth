    ...
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-2xl mx-auto space-y-8">
      <div>
        <h2 className="text-3xl font-extrabold text-[#1a1a1a] dark:text-white flex items-center gap-3">
          <Lock className="w-8 h-8 text-[#7c1f31]" />
          Setări Cont
        </h2>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-red-50 dark:bg-red-900/10 p-6 rounded-3xl border border-red-200 dark:border-red-900/50 shadow-sm space-y-6">
          ...
          <div className="flex flex-col gap-4 items-start">
              ...
              {showDeleteConfirm ? (
                  <div className="flex flex-col sm:flex-row items-center gap-3 w-full bg-red-100 dark:bg-red-900/30 p-4 rounded-xl border border-red-200 dark:border-red-800 mt-2">
                      <span className="text-sm font-medium text-red-800 dark:text-red-300 flex-1 text-center sm:text-left">Această acțiune este ireversibilă. Continui?</span>
                      <div className="flex gap-2">
                        <button
                            onClick={() => setShowDeleteConfirm(false)}
                            className="px-4 py-2 rounded-xl border border-red-300 dark:border-red-700 text-red-900 dark:text-red-200 font-medium hover:bg-red-200 dark:hover:bg-red-900/50 transition-colors"
                        >
                            Anulează
                        </button>
                        <button
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-xl border border-red-300 dark:border-red-800 text-red-700 dark:text-red-400 font-medium hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors mt-4"
                  >
