    ...
    >
      ...
      <div className="flex flex-col items-center justify-center text-center space-y-10">
        <div className="space-y-6 max-w-4xl">
          <h2 className="text-5xl md:text-7xl font-extrabold tracking-tight text-[#1a1a1a]">
            Ctrl+Alt+Truth
          </h2>
          <p className="text-2xl md:text-3xl font-medium text-[#7c1f31]">
            Democratizăm adevărul. Protejăm cuvântul scris de manipularea digitală.
          </p>
          <p className="text-lg md:text-xl text-[#1a1a1a]/80 leading-relaxed max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <button 
            ...
            className="inline-flex items-center justify-center rounded-2xl min-h-[44px] text-xl font-bold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1a1a1a] bg-white border-2 border-[#1a1a1a] text-[#1a1a1a] hover:bg-[#1a1a1a] hover:text-white hover:shadow-lg hover:-translate-y-1 h-16 px-10 gap-3"
          >
            Joacă Swipe Game
          </button>
        </div>
      ...
      <div className="bg-white rounded-3xl p-10 md:p-16 border border-[#1a1a1a]/10 shadow-sm flex flex-col lg:flex-row gap-12 items-center">
        <div className="flex-1 space-y-6">
          <div className="bg-[#7c1f31]/10 p-4 rounded-2xl inline-block mb-2">
            <ShieldCheck className="w-10 h-10 text-[#7c1f31]" />
          </div>
          <h3 className="text-3xl md:text-4xl font-bold text-[#1a1a1a]">Misiunea Noastră</h3>
        ...
        <div className="w-full lg:w-1/3 bg-[#e7edeb] p-6 rounded-2xl border border-[#1a1a1a]/10">
          <h4 className="font-bold text-[#1a1a1a] mb-4 text-center">Simularea Răspândirii Dezinformării</h4>
          <div className="grid grid-cols-10 gap-1 aspect-square">
            {dots.map((state, i) => (
              <div 
                key={i} 
                className={`w-full h-full rounded-full transition-colors duration-300 ${state === 'infected' ? 'bg-[#7c1f31] shadow-[0_0_8px_rgba(124,31,49,0.6)]' : 'bg-gray-300'}`}
              />
            ))}
          </div>
      ...
      <div className="space-y-10">
        <div className="text-center space-y-4">
          <h3 className="text-3xl md:text-4xl font-bold text-[#1a1a1a]">Radiografia Dezinformării în România</h3>
          <p className="text-xl text-[#7c1f31] font-medium">De ce suntem extrem de vulnerabili</p>
        </div>

        <div className="grid gap-8 grid-cols-1 md:grid-cols-3">
          <div className="bg-white p-8 rounded-3xl border border-[#1a1a1a]/10 shadow-md flex flex-col items-center text-center space-y-6">
            <div className="bg-[#7c1f31]/10 p-4 rounded-full">
              <BarChart3 className="w-8 h-8 text-[#7c1f31]" />
            </div>
            <div className="w-full space-y-2">
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div className="bg-[#7c1f31] h-3 rounded-full transition-all duration-1000 ease-out" style={{ width: statsAnimated ? '28%' : '0%' }}></div>
              </div>
            </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-[#1a1a1a]/10 shadow-md flex flex-col items-center text-center space-y-6">
            <div className="bg-[#7c1f31]/10 p-4 rounded-full">
              <Globe className="w-8 h-8 text-[#7c1f31]" />
            </div>
            <div className="w-full space-y-2">
              <div className="flex justify-between text-sm font-bold text-[#1a1a1a]">
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div className="bg-[#7c1f31] h-3 rounded-full transition-all duration-1000 ease-out delay-300" style={{ width: statsAnimated ? '97%' : '0%' }}></div>
              </div>
            </div>
            <p className="text-[#1a1a1a]/80 text-lg font-medium">
          ...
          <div className="bg-white p-8 rounded-3xl border border-[#1a1a1a]/10 shadow-md flex flex-col items-center text-center space-y-6">
            <div className="bg-[#7c1f31]/10 p-4 rounded-full">
              <Smartphone className="w-8 h-8 text-[#7c1f31]" />
            </div>
            <div className="w-full space-y-2">
              <div className="flex justify-between text-sm font-bold text-[#1a1a1a]">
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div className="bg-[#7c1f31] h-3 rounded-full transition-all duration-1000 ease-out delay-500" style={{ width: statsAnimated ? '70%' : '0%' }}></div>
              </div>
            </div>
            <p className="text-[#1a1a1a]/80 text-lg font-medium">
      ...
      <div className="space-y-10">
        <div className="text-center space-y-4">
          <h3 className="text-3xl md:text-4xl font-bold text-[#1a1a1a]">Cum funcționează Laboratorul de Adevăr?</h3>
          <p className="text-xl text-[#7c1f31] font-medium">3 pași simpli pentru a-ți antrena mintea</p>
        </div>
        
        <div className="grid gap-8 grid-cols-1 md:grid-cols-3 relative">
          {/* Optional connecting line for desktop */}
          <div className="hidden md:block absolute top-1/2 left-1/6 right-1/6 h-0.5 bg-[#7c1f31]/20 -z-10 -translate-y-1/2"></div>
          
          <div className="bg-white p-8 rounded-3xl border border-[#1a1a1a]/10 shadow-md flex flex-col items-center text-center space-y-4 relative z-0">
            <div className="w-12 h-12 rounded-full bg-[#7c1f31] text-white flex items-center justify-center text-2xl font-bold mb-2 shadow-lg">1</div>
            <h4 className="text-2xl font-bold text-[#1a1a1a]">Alege un subiect</h4>
          ...
          <div className="bg-white p-8 rounded-3xl border border-[#1a1a1a]/10 shadow-md flex flex-col items-center text-center space-y-4 relative z-0">
            <div className="w-12 h-12 rounded-full bg-[#7c1f31] text-white flex items-center justify-center text-2xl font-bold mb-2 shadow-lg">2</div>
            <h4 className="text-2xl font-bold text-[#1a1a1a]">Analizează textul</h4>
            <p className="text-[#1a1a1a]/80 text-lg">
          ...
          <div className="bg-white p-8 rounded-3xl border border-[#1a1a1a]/10 shadow-md flex flex-col items-center text-center space-y-4 relative z-0">
            <div className="w-12 h-12 rounded-full bg-[#7c1f31] text-white flex items-center justify-center text-2xl font-bold mb-2 shadow-lg">3</div>
            <h4 className="text-2xl font-bold text-[#1a1a1a]">Înțelege manipularea</h4>
            <p className="text-[#1a1a1a]/80 text-lg">
